...
class Menu:
    def __init__(self, title, question, exit_msg="Exit this menu", no_numbered_opts_msg=""):
        """
        Creates a menu.

        : param title       The menu title (tuple or str)
        : param question    The question to invite user input (tuple or str)
        : param exit_msg    The message for exit option (tuple or str)
        : param no_numbered_opts_msg The message shown if there are no numbered options
        ...
        self.no_numbered_opts_msg   = disp.join(no_numbered_opts_msg)

        self.add_static_opt('Q', exit_msg, self.__exit)
    ...
    def __print_numbered_opts(self):
        ...
        elif self.no_numbered_opts_msg != "":
            disp.menu_option(' ', self.no_numbered_opts_msg)
    ...
    def __print_static_opts(self):
        ...
        for char in sorted(self.static_opts):
            if char != 'Q':
